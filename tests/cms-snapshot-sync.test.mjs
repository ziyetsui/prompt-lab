...
test('mirror workflow isolates credentials on fresh runners and performs a normal CAS main push', async () => {
  ...
  assert.match(workflow, /MIRROR_PUSH_TOKEN: \$\{\{ secrets\.MIRROR_PUSH_TOKEN \}\}/)
